...
var reducer = (function (state, action) {
  ...
  if (action.type === 'UPDATE_DROPPABLE_IS_ENABLED') {
    ...
    !_target2 ? process.env.NODE_ENV !== "production" ? invariant(false, "Cannot find Droppable[id: " + _id2 + "] to toggle its enabled state") : invariant(false) : void 0;
    !(_target2.isEnabled !== isEnabled) ? process.env.NODE_ENV !== "production" ? invariant(false, "Trying to set droppable isEnabled to " + String(isEnabled) + "\n      but it is already " + String(_target2.isEnabled)) : invariant(false) : void 0;
  ...
  if (action.type === 'UPDATE_DROPPABLE_IS_COMBINE_ENABLED') {
    ...
    !_target3 ? process.env.NODE_ENV !== "production" ? invariant(false, "Cannot find Droppable[id: " + _id3 + "] to toggle its isCombineEnabled state") : invariant(false) : void 0;
    !(_target3.isCombineEnabled !== isCombineEnabled) ? process.env.NODE_ENV !== "production" ? invariant(false, "Trying to set droppable isCombineEnabled to " + String(isCombineEnabled) + "\n      but it is already " + String(_target3.isCombineEnabled)) : invariant(false) : void 0;
