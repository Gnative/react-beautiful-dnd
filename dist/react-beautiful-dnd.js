(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('redux'), require('react-redux'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'redux', 'react-redux', 'react-dom'], factory) :
  (global = global || self, factory(global.ReactBeautifulDnd = {}, global.React, global.redux, global.reactRedux, global.ReactDOM));
}(this, (function (exports, React, redux, reactRedux, ReactDOM) { 'use strict';
  ...
  var reducer = (function (state, action) {
    ...
    if (action.type === 'UPDATE_DROPPABLE_IS_ENABLED') {
      ...
      !_target2 ?  invariant(false, "Cannot find Droppable[id: " + _id2 + "] to toggle its enabled state")  : void 0;
      !(_target2.isEnabled !== isEnabled) ?  invariant(false, "Trying to set droppable isEnabled to " + String(isEnabled) + "\n      but it is already " + String(_target2.isEnabled))  : void 0;

      var updated = _extends({}, _target2, {
        isEnabled: isEnabled
      });
    ...
    if (action.type === 'UPDATE_DROPPABLE_IS_COMBINE_ENABLED') {
      ...
      var _action$payload5 = action.payload,
          _id3 = _action$payload5.id,
          isCombineEnabled = _action$payload5.isCombineEnabled;
      var _target3 = state.dimensions.droppables[_id3];
      !_target3 ?  invariant(false, "Cannot find Droppable[id: " + _id3 + "] to toggle its isCombineEnabled state")  : void 0;
      !(_target3.isCombineEnabled !== isCombineEnabled) ?  invariant(false, "Trying to set droppable isCombineEnabled to " + String(isCombineEnabled) + "\n      but it is already " + String(_target3.isCombineEnabled))  : void 0;

      var _updated = _extends({}, _target3, {
    ...
    if (action.type === 'DROP_ANIMATE') {
      var _action$payload6 = action.payload,
          completed = _action$payload6.completed,
          dropDuration = _action$payload6.dropDuration,
          newHomeClientOffset = _action$payload6.newHomeClientOffset;
  ...
  var updateDroppableDimensions = function updateDroppableDimensions(args) {
    return {
  ...
  var createDimensionMarshal = (function (registry, callbacks) {
    ...
    var updateDroppableDimensions = function updateDroppableDimensions(id, dimensionsOffsets) {
      callbacks.updateDroppableDimensions({
        id: id,
        dimensionsOffsets: dimensionsOffsets
      });
    };
    ...
    var marshal = {
      ...
      updateDroppableDimensions: updateDroppableDimensions,
  ...
  function useDroppablePublisher(args) {
    ...
    useIsomorphicLayoutEffect(function () {
      marshal.updateDroppableDimensions(publishedDescriptorRef.current.id, args.dimensionsOffset);
  ...
  function Droppable(props) {
    ...
    var children = props.children,
        ...
        dimensionsOffset = props.dimensionsOffset;
